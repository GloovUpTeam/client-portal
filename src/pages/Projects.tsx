...
export const Projects: React.FC = () => {
  ...
  const { projects, isLoading, addProject } = useProjectContext();
  ...
  return (
    <div className="space-y-6 animate-fade-in relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        {/* New Project Button wired to Modal */}
        <Button 
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-brand-surface border border-neutral-800 rounded-xl">
          ...
          <p className="text-neutral-400 mt-1">Try adjusting your search terms or create a new project.</p>
        </div>
      )}
